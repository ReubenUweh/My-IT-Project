...
// Get all assignments
$query = "SELECT id, assignmentTitle FROM assignments ORDER BY create_time DESC";
...
// Fetch latest submissions (limit 3)
$query = "SELECT fileName, create_time FROM submissions ORDER BY create_time DESC LIMIT 3";
$result = $conn->query($query);
